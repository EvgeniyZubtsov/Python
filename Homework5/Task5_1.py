...
def search(first_dict,second_dict):
    return (set(first_dict.values()) & set(second_dict.values()))



print(search(anya,sveta))
print(search(anya,nastya))
print(search(olya,sveta))
print(search(sveta,anya))